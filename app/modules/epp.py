...
def renovar_epp(usuario):
    ...
    asignaciones = supabase.from_('epp_asignaciones').select(
        '*, epp_catalogo(*), usuarios!epp_asignaciones_trabajador_id_fkey(id, nombre_completo, area)'
...
def dashboard_epp(usuario):
    ...
    query = supabase.from_('epp_asignaciones').select(
        '*, epp_catalogo(nombre, categoria), usuarios!epp_asignaciones_trabajador_id_fkey(nombre_completo, area)'
    )
